...
\begin{table}[t]
\caption{\textbf{Pointwise versus population constraints} (core mean $\pm$ sd, seeds 42--44). The per-sample thermostat (psdc) pins each example's predicted difficulty to $p^\star$; the flagship pins only the batch mean. Sudoku columns (selected ckpt) show the signature collapse. $^\dagger$one seed's evaluation completed at 43 of 44 shards (final repair in flight); the cell can move by at most a few tenths.}
\label{tab:pointwise}
\begin{center}
\resizebox{0.98\linewidth}{!}{%
...
Dream-7B & \textbf{44.2\,$\pm$\,0.8} & \textbf{44.6\,$\pm$\,1.3} & 43.5\,$\pm$\,0.3$^\dagger$ & 43.8\,$\pm$\,0.5 & 17.6 & 16.5 \\
LLaDA-1.5 & 40.8\,$\pm$\,1.4 & \textbf{41.4\,$\pm$\,0.3} & \textbf{41.0\,$\pm$\,0.1}$^\dagger$ & 40.2\,$\pm$\,0.2 & 17.1 & 14.7 \\
12K & \textbf{40.7\,$\pm$\,0.7} & \textbf{39.6\,$\pm$\,0.7} & 38.8$^\dagger$ & 39.0\,$\pm$\,1.7 & 16.0 & \textbf{10.7} \\
\bottomrule
\end{tabular}}
\end{center}
\end{table}
...
per-sample cap & $39.0{\pm}0.7$ / $40.9{\pm}0.7$ & $43.6^{\S}$ / $43.8{\pm}0.5$ & $41.0^{\S}$ / $40.2{\pm}0.2$ & $38.8^\ddagger$ / --- \\
